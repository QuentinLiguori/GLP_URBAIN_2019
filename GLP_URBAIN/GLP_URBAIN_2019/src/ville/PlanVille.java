...
//******************Creation des batiments****************************************//
		...
		BatimentCible resto1 = new BatimentCible("RestoChinoi","Manger",0,50,11,23,hgResto1,bgResto1,15);
		batiments.put("RestoChinoi",resto1);
		Point hgResto2 = new Point(120,450);
		Point bgResto2 = new Point(300,550);
		BatimentCible resto2 = new BatimentCible("RestoChinoi","Manger",0,50,11,23,hgResto2,bgResto2,15);
		batiments.put("RestoChinoi",resto2);
		...
		batiments.put("RestoChinoi",resto3);
		Point hgCinema = new Point(120,590);
		Point bgCinema = new Point(300,590);
		BatimentCible cinema = new BatimentCible("Cinema","Détente",0,45,10,22,hgCinema,bgCinema,12);
		batiments.put("Cinema",cinema);
		Point hgBar1 = new Point(360,590);
		Point bgBar1 = new Point(540,690);
		BatimentCible bar1 = new BatimentCible("Bar","Détente",0,52,12,23,hgBar1,bgBar1,14);
		batiments.put("Bar",bar1);
		Point hgParc = new Point(840,450);
		Point bgParc = new Point(1020,550);
		BatimentCible parc = new BatimentCible("Parc","Détente",0,45,10,22,hgParc,bgParc,12);
		...
		BatimentCible bar2 = new BatimentCible("Bar2","Détente",0,52,12,23,hgBar2,bgBar2,14);
		batiments.put("Bar2",bar2);
		...
		batiments.put("FastFood3",fastFood3);
